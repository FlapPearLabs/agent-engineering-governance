...
│   └── project-continuity-contract.md     PROJECT_CONTINUITY_CONTRACT_V1（project-state 索引 /
│                                          生命周期 / grounding / ZCode hook 参考）
├── schemas/ + templates/      ← .agent/project-state.json 的 normative schema 与占位符模板
